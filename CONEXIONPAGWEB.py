...
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpcCI6IiJzdXBhYmFzZS5jby" # Asegúrate de que esta sea tu llave larga completa
    ...
    try:
        ...
        if response.data:
            ...
            fig_pie = px.pie(df_sexo, values='Total Alumnos', names='Sexo',
                             color='Sexo', color_discrete_map={'M':'#3498db', 'F':'#e74c3c', 'O':'#9b59b6'}, hole=0.2)

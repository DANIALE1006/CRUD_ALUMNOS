...
# 1. CONFIGURACIÓN VISUAL DEL NAVEGADOR LOCAL
st.set_page_config(
...
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpcCI6IiJzdXBhYmFzZS5jby" # Usa tu clave anon aquí
...
# ==========================================
    ...
    try:
        ...
        if solicitud.data:
            ...
            # Forzado numérico para evitar errores estadísticos
